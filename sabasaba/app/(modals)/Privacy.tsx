  ...
  render(){
    return (
     <View style={styles.container}>
            ...
            >
                <Text style={styles.tcP}>Welcome to our 7saba. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern 7saba’s relationship with you in relation to this website. If you disagree with any part of these terms and conditions, please do not use our website.</Text>
                <Text style={styles.tcP}>The term 7saba or ‘us’ or ‘we’ refers to the owner of the website whose registered office is 7saba. 
                {/* Our company registration number is [company registration number and place of registration].  */}
                The term ‘you’ refers to the user or viewer of our website.</Text>
                    ...
                    <Text style={styles.tcL}>{'\u2022'} This website uses cookies to monitor browsing preferences. If you do allow cookies to be used, the following personal information may be stored by us for use by third parties: 
